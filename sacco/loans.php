		...
		<div class="card">
			<div class="card-header">
				<large class="card-title">
					...
					<button style="margin-right: 10px;" onclick="printDiv()" class="btn btn-success  col-md-2 float-right" type="button" id="print_payment"><i class="fa fa-print"></i> Print</button>
				</large>
				  
			</div>
			<div class="card-body" id="loaning">
...
<style>
 ...
 <script>
        function printDiv() {
            var loaning = document.getElementById("loaning").innerHTML;
            var a = window.open('', '', 'height=500, width=500');
            a.document.write('<html>');
            a.document.write('<body > <h1><center>Client loan Details</center></h1> <br>');
            a.document.write(loaning);
