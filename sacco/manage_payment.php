...
<div class="container-fluid">
	<div class="col-lg-12">
		<form id="manage-payment">
			...
			<input type="hidden" name="laodid" value="<?php echo isset($_GET['loan_id']) ? $_GET['loan_id'] : '' ?>">
			<input type="hidden" name="pay" value="<?php echo isset($_GET['payee']) ? $_GET['payee'] : '' ?>">
			<input type="hidden" name="amt" value="<?php echo isset($_GET['amount']) ? $_GET['amount'] : '' ?>">
			<div class="row">
				<div class="col-md-4">
